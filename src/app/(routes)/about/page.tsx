        ...
        <section className='px-4 py-2 relative'>
            <div className="w-full lg:max-w-5xl xl:max-w-7xl m-auto py-10 flex flex-col gap-4">
                ...
                <div className="flex flex-row flex-wrap gap-10 mt-10">
                    <div className="flex-1 flex flex-col items-center justify-center gap-4 min-w-28 h-36 md:h-52 border border-borderColor rounded hover:bg-buttonColor group transition-all ease-in-out duration-300">
                        ...
                        <p className='hidden md:block group-hover:text-white transition-all ease-in-out duration-300'>Sallers active our site</p>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-4 min-w-28 h-36 md:h-52 border border-borderColor rounded hover:bg-buttonColor group transition-all ease-in-out duration-300">
                        ...
                        <p className='hidden md:block group-hover:text-white transition-all ease-in-out duration-300'>Mopnthly Produduct Sale</p>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-4 min-w-28 h-36 md:h-52 border border-borderColor rounded hover:bg-buttonColor group transition-all ease-in-out duration-300">
                        ...
                        <p className='hidden md:block group-hover:text-white transition-all ease-in-out duration-300'>Customer active in our site</p>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center gap-4 min-w-28 h-36 md:h-52 border border-borderColor rounded hover:bg-buttonColor group transition-all ease-in-out duration-300">
                        ...
                        <p className='hidden md:block group-hover:text-white transition-all ease-in-out duration-300'>Anual gross sale in our site</p>
                    </div>
                </div>
