...
export default function CategoriesCarousel() {
    ...
    const categories = [
        { icon: MenFashionIcon, title: "Men's Fashion" },
        { icon: WomenFashionIcon, title: "Women's Fashion" },
        { icon: PhoneIcon, title: "Phones" },
        { icon: ComputerIcon, title: "Computer" },
        { icon: GamingIcon, title: "Gaming" },
        { icon: HeadphoneIcon, title: "HeadPhones" },
        { icon: CameraIcon, title: "Camera" },
        { icon: SmartWatchIcon, title: "Smart Watch" },
    ];
            ...
            >
                {categories.map((cat, idx) => {
                    ...
                    return (
                        ...
                        >
                            <Icon className="text-black group-hover:text-white transition-all ease-in-out duration-300 w-14 h-14" />
                            <h1 className="group-hover:text-white transition-all ease-in-out duration-300">
                                {cat.title}
                            </h1>
                        </div>
                    )
