        ...
        <section className=''>
            ...
            <div id="toast-success" className="flex items-center w-full max-w-sm p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default" role="alert">
                ...
                <div className="flex items-center space-x-2 mb-4">
                    <div className="w-full bg-neutral-quaternary rounded-full h-1.5">
                        <div className="bg-brand h-1.5 rounded-full" style={{ width: '75%' }} />
                    </div>
                    <div className="text-xs font-medium text-heading">75%</div>
                </div>
            </div>
        </section>
    )
