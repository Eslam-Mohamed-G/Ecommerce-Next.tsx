...
export const CameraIcon: React.FC<IconProps> = ({ className = "", width = 56, height = 56 }) => (
    <svg width={width} height={height} className={className} aria-hidden="true" viewBox="0 0 56 56" fill="none" stroke="currentColor">
        <g clipPath="url(#clip0_23436_1952)">
...
export const HeadphoneIcon: React.FC<IconProps> = ({ className = "", width = 56, height = 56 }) => (
    <svg width={width} height={height} viewBox="0 0 56 56" fill="none" stroke="currentColor" className={className} aria-hidden="true">
        <g clipPath="url(#clip0_138_1699)">
            <path d="M16.3334 30.3333H14C11.4227 30.3333 9.33337 32.4227 9.33337 35V42C9.33337 44.5773 11.4227 46.6666 14 46.6666H16.3334C18.9107 46.6666 21 44.5773 21 42V35C21 32.4227 18.9107 30.3333 16.3334 30.3333Z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            <path d="M42 30.3333H39.6667C37.0893 30.3333 35 32.4227 35 35V42C35 44.5773 37.0893 46.6666 39.6667 46.6666H42C44.5773 46.6666 46.6667 44.5773 46.6667 42V35C46.6667 32.4227 44.5773 30.3333 42 30.3333Z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9.33337 35V28C9.33337 23.0493 11.3 18.3013 14.8007 14.8007C18.3014 11.3 23.0493 9.33331 28 9.33331C32.9507 9.33331 37.6987 11.3 41.1994 14.8007C44.7 18.3013 46.6667 23.0493 46.6667 28V35" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
